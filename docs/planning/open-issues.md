...
| I-17 | セレンディピティの冊数 | ✅**2026-06-18 MTGで確定** | **日曜1セット（4冊）に決定**（旧暫定5冊→新4冊）。週3回×4冊/回=週12冊のうち、日曜の1回分（4冊）をセレンディピティセットとして提供。通常入荷（本命）は停止。週計: 本命8冊（2回×4冊）＋セレンディピティ4冊（1回×4冊）=12冊。4週保持=最大48冊【MTG 2026-06-18・3.2】 |
...
| I-29 | **入荷保持期間・最大件数の変更（7日→4週間・最大48冊）** | 🔴未実装（2026-06-18 MTG決定） | **MTG 2026-06-18 で確定**。旧: 7日ウィンドウ（`ARRIVAL_WINDOW_DAYS=7`・最大15冊）→ **新: 過去4週間（28日）・最大約48冊**（4冊×3回/週×4週=48冊。内訳: 本命4冊×2回=週8冊＋セレンディピティ4冊×1回=週4冊=週12冊）。フロント `apps/web/src/lib/arrival.ts` の `ARRIVAL_WINDOW_DAYS=7` を 28 に変更、書店トップのフィルタリングロジックを4週間保持に対応させる必要あり。スケーラビリティは既存の検索機能で担保確認済み【MTG 2026-06-18・3.2・arrival.ts】 |
...
- ~~✅ 週3回・曜日別トリガー（土/水=本命・日=セレンディピティ）／読者分析は土朝の週1回【2026-06-03】~~ → **【2026-06-18 MTG改定】** 週3回×4冊/回=週12冊（本命2回×4冊=8冊＋日曜セレンディピティ1回×4冊=4冊）・保持4週間・最大48冊（I-17/I-29更新）
...
- ✅ 本文ボリューム＝約100ページ【確定済】
- ~~✅ 週15冊の表紙生成＝MVP/デモは全冊先行生成【2026-06-03】~~ → **【2026-06-18 MTG改定】** 週12冊（4冊×3回: 本命2回+セレンディピティ1回）=週12冊・4週保持48冊。全冊先行生成方針は維持（I-29参照）
