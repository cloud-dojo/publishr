...
①title（この読者に刺さるエッジ。ただし**一般のビジネス書として何の本か一目で分かる分かりやすさ・簡潔さを最優先**＝抽象的すぎ/長すぎ/凝りすぎを避ける。言い切り型を基本にし、問いかけ型は使ってよいが多用しない＝棚の全タイトルを問いかけにしない。人数等は読者の base.orgScale に整合させる）
②subtitle（主題の言い換え）
